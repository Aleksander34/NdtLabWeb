...
$(function () {
	...
	// 	});
	// })
	let f1 = initColumnFilter('#example', '.tableColumnFilter[data-num="3"]');
	let f2 = initColumnFilter('#example', '.tableColumnFilter[data-num="2"]');
	let f3 = initColumnFilter('#example', '.tableColumnFilter[data-num="1"]');
});
